...
public class ReportDAO {
	public String getIncomeExpenseSummary(String fromDate, String toDate) {
		...
		String query = "SELECT Cust_ID,date(Modified_Dt) as Modified_Dt ,Cust_Name,Cust_CR_Amt,Cust_DR_Amt,Cust_Outstanding FROM Customer_Info where Cust_Status='ACTIVE' and Modified_Dt between '"
				+ fromDate + "' and " + "DATE_ADD('" + toDate
				+ "', INTERVAL 1 DAY) and (cust_cr_amt != 0 or cust_dr_amt !=0)";
		ResultSet rSet = null;
