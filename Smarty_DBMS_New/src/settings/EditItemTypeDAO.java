...
public class EditItemTypeDAO {
	
	public String editItemTypeDtls(HashMap EditCustTypeData){
		...
		try{
			...
			psmt1.setString(1, (String)EditCustTypeData.get("Edit_ItemTypeName_key"));
			psmt1.setString(2, (String)EditCustTypeData.get("Edit_ItemTypeDescription_key"));
			psmt1.setString(3, (String)EditCustTypeData.get("Edit_ItemTypeID_key"));
