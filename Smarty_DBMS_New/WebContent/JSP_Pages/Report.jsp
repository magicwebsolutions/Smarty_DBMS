	...
	<nav class="innerNavigation navbar-default">
	 <div id="navbarCollapse" class="collapse navbar-collapse">
           <ul class="nav navbar-nav">
               ...
               <li><a href="<%=request.getContextPath()%>/JSP_Pages/Report_Customer.jsp")>Customer Summary</a></li>
               <li><a href="<%=request.getContextPath()%>/JSP_Pages/Report_Stock.jsp")>Stock Summary</a></li>
           </ul>
       </div>
	</nav>
...
<script>
var globalContextURL = "<%=request.getContextPath()%>";
